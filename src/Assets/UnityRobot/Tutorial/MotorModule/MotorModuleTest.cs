...
public class MotorModuleTest : MonoBehaviour
{
	public RobotProxy robot;
	public MotorModule motor;
	...
	void OnGUI()
	{
		...
		if(robot.Connected == true)
		{
			...
			motor.speed = (int)GUILayout.HorizontalSlider(motor.speed, -100, 100);
			GUILayout.Label(string.Format("Motor speed: {0:f}", motor.speed));
