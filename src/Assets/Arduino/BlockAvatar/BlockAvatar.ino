...
#define L_SHOULDER_PITCH_MIN 319
#define L_SHOULDER_PITCH_MAX 687
#define L_SHOULDER_ROLL_MIN 264
#define L_SHOULDER_ROLL_MAX 704
#define L_SHOULDER_YAW_MIN 512
#define L_SHOULDER_YAW_MAX 512
#define L_ELBOW_MIN 512
#define L_ELBOW_MAX 697
#define R_SHOULDER_PITCH_MIN 337
#define R_SHOULDER_PITCH_MAX 692
#define R_SHOULDER_ROLL_MIN 287
#define R_SHOULDER_ROLL_MAX 760
#define R_SHOULDER_YAW_MIN 512
#define R_SHOULDER_YAW_MAX 512
#define R_ELBOW_MIN 315
#define R_ELBOW_MAX 512

ServoModule L_Shoulder_Pitch(2, 0, -160, 160);
ServoModule L_Shoulder_Roll(3, 1, -160, 160);
ServoModule L_Shoulder_Yaw(4, 2, -160, 160);
ServoModule L_Elbow(5, 3, -160, 160);
ServoModule R_Shoulder_Pitch(7, 4, -160, 160);
ServoModule R_Shoulder_Roll(8, 5, -160, 160);
ServoModule R_Shoulder_Yaw(9, 6, -160, 160);
ServoModule R_Elbow(10, 7, -160, 160);
